...
class TestCLIErrorFlows:
    """Test error handling flows in CLI commands."""
    ...
    def test_typer_exit_not_swallowed(self):
        ...
        with patch.dict(os.environ, {}, clear=True):
            with patch("data4ai.config.settings") as mock_settings:
...
class TestErrorMessageContent:
    ...
    def test_error_messages_contain_guidance(self):
        ...
        test_cases = [
            # (env_vars, command, expected_guidance)
            (
                {"OPENROUTER_API_KEY": ""},

...
def example_1_quick_start():
    ...
    try:
        ...
        print(f"📁 Output would be saved to: data/python-qa-example/")
        print(f"📊 Schema: alpaca")
...
def example_2_document_generation():
    ...
    try:
        ...
        print(f"📊 Schema: chatml (conversation format)")
...
def example_4_batch_processing():
    ...
    try:
        from data4ai import generate_from_description  # noqa: F401 - Used in commented code below
